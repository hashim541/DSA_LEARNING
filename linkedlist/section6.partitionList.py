...
class LinkedList:
    ...
    def partition_list(self,x):
        ...
        while temp :
            ...
            temp=temp.next
        if dummy1 is not None and dummy2 is not None:
            d1temp.next=dummy2.head
            self.head = dummy1.head
            dummy1.print_list()
        elif dummy1 is not None and dummy2 is None:
            self.head=dummy1.head
        elif dummy1 is None and dummy2 is not None:
